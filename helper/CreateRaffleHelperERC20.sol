...
abstract contract CreateRaffleHelperERC20 is Test {
    ...
    // function addTokenToApprovedList () internal {
    //    // ManagerERC20.addTokenToApprovedList(token);
    // }


    function createRaffleERC20() internal {
        ...
        TestRaffleStruct memory raffle_test = TestRaffleStruct({
            ...
            winner: alice,
            randomNumber: 0, // set an initial value for randomNumber
            seller: alice,
            platformPercentage: 0, // set an initial value for platformPercentage
            entriesLength: entriesLength,
            expiryTimeStamp: expiryTimeStamp,
            randomNumberAvailable: false // set an initial value for randomNumberAvailable
        });
